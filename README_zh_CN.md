...
[![Go Version](https://img.shields.io/badge/go-%3E%3D1.20-green.svg)](https://github.com/golang)
...
你可以从[这里](https://github.com/therehello/cf-tool/releases)直接下载一个可执行文件。
...
例子:
  ...
  cf clone therehello      拉取 therehello 的所有提交代码。
...
模板内的脚本:
  ...
  $%path%$   代码的路径 (不包括 $%full%$， 比如 "/home/therehello/")
