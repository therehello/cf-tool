...
[![Github release](https://img.shields.io/github/release/woshiluo/cf-tool.svg)](https://github.com/woshiluo/cf-tool/releases)
[![platform](https://img.shields.io/badge/platform-Windows%20%7C%20macOS%20%7C%20Linux-blue.svg)](https://github.com/woshiluo/cf-tool/releases)
[![Build Status](https://travis-ci.org/woshiluo/cf-tool.svg?branch=master)](https://travis-ci.org/woshiluo/cf-tool)
[![Go Report Card](https://goreportcard.com/badge/github.com/woshiluo/cf-tool)](https://goreportcard.com/report/github.com/woshiluo/cf-tool)
[![Go Version](https://img.shields.io/badge/go-%3E%3D1.12-green.svg)](https://github.com/golang)
[![license](https://img.shields.io/badge/license-MIT-%23373737.svg)](https://raw.githubusercontent.com/woshiluo/cf-tool/master/LICENSE)
...
你可以从[这里](https://github.com/woshiluo/cf-tool/releases)直接下载一个可执行文件。
...
```plain
$ go get github.com/woshiluo/cf-tool
$ cd $GOPATH/src/github.com/woshiluo/cf-tool
...
例子:
  ...
  cf clone woshiluo      拉取 woshiluo 的所有提交代码。
...
模板内的脚本:
  ...
  $%path%$   代码的路径 (不包括 $%full%$， 比如 "/home/woshiluo/")
 ...
 * You can download the binary file in here https://github.com/woshiluo/cf-tool (Windows, macOS, Linux)
 * Author: $%U%$
 * Time: $%Y%$-$%M%$-$%D%$ $%h%$:$%m%$:$%s%$
**/
